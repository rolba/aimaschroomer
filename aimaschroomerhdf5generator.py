...
trainingSetMeanPath = os.path.join(splittedSetPath, "mean")
...
def main():
    ...
    for singleSetPath in dataSet:
        ...
        writer = DatasetWriter(singleSetPath[:-3]+"h5py", (len(dataPaths), 299, 299, 3))
    ...
    f = open(os.path.join(trainingSetMeanPath, "train_mean.json"), "w")
