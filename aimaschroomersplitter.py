...
# My data splitter. I made it previously so I reused it for this project
...
def main():
    ...
    datasetPath = os.getcwd() + "/data_prep"
    ...
    for (i, classFolder) in enumerate (os.listdir(datasetPath)):
        ...
        datasetDetectedClass = os.path.join(datasetPath, classFolder)
